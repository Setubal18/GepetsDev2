...
@Component({
  selector: 'page-avaliacao4',
  templateUrl: 'avaliacao4.html',
})
export class Avaliacao4Page {

//Arrays de pergunta  e a base de imagem
  avaliacao3 = this.navParams.get('avaliacao3');
  selecionado = [];
  imcAtual : any =[];
...
// Variaveis com operações matematicas
  ...
  imcIdeal = this.navParams.get('imcIdeal');
  imcSexoOposto;
